...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DataRequest.public'
        db.add_column(u'data_datarequest', 'public',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


        # Changing field 'DataRequest.requested'
        db.alter_column(u'data_datarequest', 'requested', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

    def backwards(self, orm):
        # Deleting field 'DataRequest.public'
        db.delete_column(u'data_datarequest', 'public')


        # Changing field 'DataRequest.requested'
        db.alter_column(u'data_datarequest', 'requested', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))
