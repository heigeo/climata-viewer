...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'data_webservice', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('homepage', self.gf('django.db.models.fields.URLField')(max_length=200)),
            ('authority', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['identify.Authority'])),
            ('class_name', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
        db.send_create_signal(u'data', ['Webservice'])

        # Adding model 'DataRequest'
        db.create_table(u'data_datarequest', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, blank=True)),
            ('webservice', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['data.Webservice'])),
        ...
        db.send_create_signal(u'data', ['DataRequest'])


    def backwards(self, orm):
        # Deleting model 'Webservice'
        db.delete_table(u'data_webservice')

        # Deleting model 'DataRequest'
        db.delete_table(u'data_datarequest')
